        ...
        >
            {reportData && (
                <>
                            ...
                            <tbody className="divide-y divide-border/50">
                                {reportData.transactions.length === 0 ? (
                                    ...
                                    reportData.transactions.map((tx) => (
                                        <tr key={tx.guid} className="hover:bg-surface-hover/20 transition-colors">
                                            ...
                                            <td className="py-2 px-4 text-foreground">
                                                ...
                                                {tx.memo && (
                                                    <div className="text-xs text-foreground-muted">{tx.memo}</div>
                                                )}
                                            </td>
                    ...
                    {/* Transaction Count */}
                    <div className="p-4 border-t border-border text-sm text-foreground-secondary text-right">
