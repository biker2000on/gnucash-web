...
export const FEATURES: Feature[] = [
    ...
    { id: 'biz-1099', title: '1099-NEC Tracker', description: 'Contractor payments crossing $600, W-9 status, and the January filing pack.', href: '/business/reports/1099', domain: 'business', task: 'Reports', kind: 'report', keywords: 'contractor 1099 nec w9 tin january filing', businessOnly: true, nav: true },
