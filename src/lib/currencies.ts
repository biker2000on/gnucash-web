/**
 * ISO 4217 currency list for the currency selector component.
 */
...
/** Map of currency code to Currency object for O(1) lookup */
export const CURRENCY_MAP = new Map(CURRENCIES.map(c => [c.code, c]));

/** Get the display name for a currency code, or return the code if not found */
